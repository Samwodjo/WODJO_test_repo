...
mat_data = pd.read_csv("C:\\Users\\user\\Downloads\\Re_ WASHA Takwimu mini project\\Maternal Health Risk Data Set.csv"))
...
for var in continuous_vars:
    plt.figure()
    sns.boxplot(x=data['RiskLevel'], y=data[var], palette='orange')
